...
describe("wallclockConditionalPar.smil test", () => {
	it("processes smil file correctly", () => {
		...
		numberOfElementsExists(cy.get('body'), 'video[src*="videos/video-test_54188510.mp4"]', 1);
		...
		numberOfElementsExists(cy.iframe(), 'img[src*="images/landscape2_9a769e36.jpg"]', 1);
		testCoordinates(cy.iframe().find('img[src*="images/landscape1_68241f63.jpg"]'), 0, 0, 960, 540);
		testCoordinates(cy.iframe().find('img[src*="images/landscape2_9a769e36.jpg"]'), 540, 960, 960, 540);
