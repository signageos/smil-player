...
describe('correctOrder.smil test', () => {
    it('processes smil file correctly', () => {
        ...
        cy.iframe().find('#SMILUrl').clear().type(enums_1.SMILUrls.correctOrder);
        ...
        cy.iframe()
            .find('img[id*="landscape2_20622151.jpg-main-img4"]', { timeout: enums_1.CypressTimeouts.elementAwaitTimeout })
            .should('be.visible');
        tools_1.testCoordinates(cy.iframe().find('img[id*="landscape2_20622151.jpg-main-img4"]'), 0, 0, 1920, 1080);
        cy.get('video[src*="videos/video-test_17354648.mp4"]', { timeout: enums_1.CypressTimeouts.elementAwaitTimeout }).should('be.visible');
        cy.iframe()
            .find('img[id*="landscape2_20622151.jpg-main-img4"]', { timeout: enums_1.CypressTimeouts.elementAwaitTimeout })
            .should('not.be.visible');
