...
describe('cssBottomAndRight.smil test', () => {
	it('processes smil file correctly', () => {
		...
		cy.iframe()
			.find('img[id*="img_1_64a7_d8cb3084.jpg-video2-img1"]', { timeout: CypressTimeouts.elementAwaitTimeout })
			.should('be.visible');
		testCoordinates(cy.iframe().find('img[id*="img_1_64a7_d8cb3084.jpg-video2-img1"]'), 252, 825, 540, 608);

		cy.get('video[src*="videos/video-test_54188510.mp4"]', { timeout: CypressTimeouts.elementAwaitTimeout }).should(
			'be.visible',
		);
		testCoordinates(cy.get('video[src*="videos/video-test_54188510.mp4"]'), 364, 1188, 540, 608);
	});
});
