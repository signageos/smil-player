...
describe('repeatCountNoIntro.smil test', () => {
    it('processes smil file correctly', () => {
        ...
        cy.iframe().find('#SMILUrl').clear().type(enums_1.SMILUrls.repeatCountNoIntro);
        ...
        cy.iframe()
            .find('img[id*="landscape1_7a8cff48.jpg-main-img1"]', { timeout: enums_1.CypressTimeouts.elementAwaitTimeout })
            .should('be.visible');
        tools_1.testCoordinates(cy.iframe().find('img[id*="landscape1_7a8cff48.jpg-main-img1"]'), 0, 0, 1920, 1080);
        cy.iframe()
            .find('img[id*="landscape1_7a8cff48.jpg-main-img1"]', { timeout: enums_1.CypressTimeouts.elementAwaitTimeout })
            .should('not.be.visible');
        cy.iframe()
            .find('img[id*="landscape2_20622151.jpg-main-img2"]', { timeout: enums_1.CypressTimeouts.elementAwaitTimeout })
            .should('be.visible');
        tools_1.testCoordinates(cy.iframe().find('img[id*="landscape2_20622151.jpg-main-img2"]'), 0, 0, 1920, 1080);
        cy.iframe()
            .find('img[id*="landscape1_7a8cff48.jpg-main-img1"]', { timeout: enums_1.CypressTimeouts.elementAwaitTimeout })
            .should('be.visible');
        cy.iframe()
