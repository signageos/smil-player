...
describe('priorityDefer.smil test', () => {
    it('processes smil file correctly', () => {
        ...
        cy.iframe().find('#SMILUrl').clear().type(enums_1.SMILUrls.priorityDefer);
        ...
        cy.get('video[src*="videos/video-test_17354648.mp4"]', { timeout: enums_1.CypressTimeouts.elementAwaitTimeout }).should('not.be.visible');
        cy.iframe()
            .find('img[src*="images/img_3_4e57c7a6.jpg"]', { timeout: enums_1.CypressTimeouts.longerElementAwaitTimeout })
            .should('be.visible');
        tools_1.testCoordinates(cy.iframe().find('img[src*="images/img_3_4e57c7a6.jpg"]'), 0, 0, 1280, 720);
        cy.iframe()
            .find('img[src*="images/img_3_4e57c7a6.jpg"]', { timeout: enums_1.CypressTimeouts.elementAwaitTimeout })
