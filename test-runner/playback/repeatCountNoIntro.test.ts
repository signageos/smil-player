...
test.describe('repeatCountNoIntro.smil test', () => {
	test('processes smil file correctly', async ({ page, context, smilUrls }) => {
		...
		await expect(frame.locator('img[id*="landscape1"][id*=".jpg-main-img1"]')).toBeVisible({ timeout: Timeouts.elementAwait });
		await testCoordinates(frame.locator('img[id*="landscape1"][id*=".jpg-main-img1"]'), 0, 0, 1920, 1080);

		await expect(frame.locator('img[id*="landscape1"][id*=".jpg-main-img1"]')).not.toBeVisible({ timeout: Timeouts.elementAwait });
		await expect(frame.locator('img[id*="landscape2"][id*=".jpg-main-img2"]')).toBeVisible({ timeout: Timeouts.elementAwait });
		await testCoordinates(frame.locator('img[id*="landscape2"][id*=".jpg-main-img2"]'), 0, 0, 1920, 1080);

		await expect(frame.locator('img[id*="landscape1"][id*=".jpg-main-img1"]')).toBeVisible({ timeout: Timeouts.elementAwait });
		await expect(frame.locator('img[id*="landscape2"][id*=".jpg-main-img2"]')).not.toBeVisible({ timeout: Timeouts.elementAwait });
		await testCoordinates(frame.locator('img[id*="landscape1"][id*=".jpg-main-img1"]'), 0, 0, 1920, 1080);
