...
export interface IPlaylistDataPrepare {
	getAllInfo: (
		...
		smilUrl: string, isTrigger: boolean, triggerName: string) => Promise<void>;
	manageFilesAndInfo: (smilObject: SMILFileObject, internalStorageUnit: IStorageUnit, smilUrl: string) => Promise<void>;
}
