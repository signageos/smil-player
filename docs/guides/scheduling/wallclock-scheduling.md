...
| R/2020-01-01+w3T09:00/P2W | Starts at 9:00 am every second (P2W) Wednesday (+w3)                                                                                         |
...
+w3 designates the 3rd weekday, or Wednesday. "P1W" repeats the schedule every week.
...
ISO 8601 Durations are expressed using the following format, where (n) is replaced by the value for each of the date and
time elements that follow the (n):
...
Represents a duration/period (P) of three years (3Y), six months (6M), four days (4D), and time (T) twelve hours (12H),
thirty minutes (30M), and five seconds (5S).
